...
<div class="float-parent-element">
  ...
  <div class="float-child-element">
    <div class="yellow">
         <nav>
  <ul>
      <li><a class="ac" href="register">Back to Register</a></li>
...
<div class="inputs">
  ...
  <p>Enter OTP:</p>
  <input class="inppp" id="txt00" type="number" name="otp" onkeyup="saveValue(this);" placeholder="Check your email for the OTP" maxlength="6" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" style="text-align:center;font-size:24px"></input>
