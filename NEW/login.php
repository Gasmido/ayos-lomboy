...
<div class="inputs">
  ...
  <input id="txt5" type="text" name="user1" onkeyup="saveValue(this);" placeholder="Enter E-mail"></input>
   <p>Password:</p>
  <input id="txt6" type="password" name="pass" onkeyup="saveValue(this);" maxlength="60" placeholder="Enter password" pattern="[a-zA-Z0-9_]{1,60}" title="Only letters(A-z), underscore(_), and numbers(0-9)."></input>
  <br>
