...
if (isset($_POST['submit'])) {
	...
	if ($status == "Picked-up") {
		...
		editDocReq11($connn, $fname, $daterequest, $dt, $purok, $BI, $dof, $status, $id, $emaiil);
	}
}
elseif (isset($_POST['submit2'])) {
	...
	if ($status == "Picked-up") {
		...
		editDocReq22($connn, $fname, $daterequest, $dt, $BI, $status, $id, $emaiil); 
	}
}
elseif (isset($_POST['submit3'])) {
	...
	if ($status == "Picked-up") {
		...
		editDocReq33($connn, $Bname, $Lname,$address, $money, $BAL,$BALL, $daterequest, $dt, $status, $id, $emaiil); 
	}
}
elseif (isset($_POST['submit4'])) {
	...
	if ($status == "Picked-up") {
		...
		editDocReq44($connn,$fname, $purok,$dob, $pob, $height,$weight,$purpose, $daterequest, $dt, $status, $id, $emaiil); 
	}
}
elseif (isset($_POST['submit5'])) {
	...
	if ($status == "Picked-up") {
		...
		editDocReq55($connn, $fname, $rbrgy,$sqm, $hectare, $owner,$daterequest, $dt, $status, $id, $emaiil); 
	}
}
else {
