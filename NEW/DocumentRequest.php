    ...
    <section>
		...
		elseif ($docutype == "Blotter") {
    		...
    		<br />
				...
				<input id="y3" type="text" minlength="11" name="phonenum" class="inputt" pattern="09.\d*" title="Please Enter numbers only! e.g. 0912345689" maxlength="11" placeholder="e.g. 09123456789" required></input>
				...
				<textarea id="y5" rows="4" cols="50" type="text" name="incidentdetails" class="inputt"  onkeyup="this.value = this.value.replace(/[&*<>'; ?>'<?php echo ']/g,'; ?> ''<?php echo ')" pattern="[A-Za-z ]{1,300}" title="Please remove any special characters!" maxlength="300" placeholder="Explain what happened (max. 300 letters)" required></textarea>
