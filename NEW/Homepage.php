...
-->
		...
		<div class="homecontent hidden">
			...
			<div>
				<p class="are" style="color:whitesmoke">
						...
						<?php
							...
							if (isset($_SESSION['ID'])) {
								if ($status == "Approved") {
									...
									<a href="COR.pdf" target="_blank" style="font-size:32px;margin-left:10px" title="Download">
						...
						<?php
							if (isset($_SESSION['ID'])) {
								if ($status == "Approved") {
									...
									<a href="Indigency.pdf" target="_blank" style="font-size:32px;margin-left:10px" title="Download">
									<i class="bx bxs-download"></i>
									</a>
									';
								} elseif ($status == "Denied") {
						...
						<?php
							if (isset($_SESSION['ID'])) {
								if ($status == "Approved") {
									...
									<a href="Clearance.pdf" target="_blank" style="font-size:32px;margin-left:10px" title="Download">
									<i class="bx bxs-download"></i>
									</a>';
								} elseif ($status == "Denied") {
									echo '<p class="boxreq">Sorry but your account have been denied to access this service.</p>';
						...
						<?php
							if (isset($_SESSION['ID'])) {
								if ($status == "Approved") {
									...
									<a href="Kasunduan.pdf" target="_blank" style="font-size:32px;margin-left:10px" title="Download">
									<i class="bx bxs-download"></i>
									</a>
									';
								} elseif ($status == "Denied") {
						...
						<?php
							if (isset($_SESSION['ID'])) {
								if ($status == "Approved") {
									...
									<a href="BARC.pdf" target="_blank" style="font-size:32px;margin-left:10px" title="Download">
									<i class="bx bxs-download"></i>
									</a>';
								} elseif ($status == "Denied") {
									echo '<p class="boxreq">Sorry but your account have been denied to access this service.</p>';
