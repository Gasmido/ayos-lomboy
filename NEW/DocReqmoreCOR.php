...
<div class="adddel">
  ...
  <div class="modal-contentRr2">
    <a href="<?php if ($_SESSION['COR'] == "COR") {echo 'DocReqCOR';} elseif ($_SESSION['COR'] == "COI") {echo 'DocReqCOI';} elseif ($_SESSION['COR'] == "B") {echo 'DocReqB';} elseif ($_SESSION['COR'] == "BC") {echo 'DocReqBC';} elseif ($_SESSION['COR'] == "K") {echo 'DocReqK';} ?>">
